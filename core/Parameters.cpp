...
Parameters::Parameters()
{
	...
	fnCreateParameter(ParameterName::L, 1.0f, { 0.25f, 2.0f }); // reduced to 0.25 (originally 0.12) because of unstable range
	...
	fnCreateParameter(ParameterName::sigma1, 1.f, { 0.0008f, 0.5f }); // range reduced on right side, greater numbers are not perceptible
