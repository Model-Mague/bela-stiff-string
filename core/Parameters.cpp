...
Parameters::Parameters()
{
	...
	auto fnCreateParameter= [&](const ParameterName name, const float initValue, const std::pair<float, float>& range, const std::pair<std::string, float>& behaviour) {
	...
	fnCreateParameter(ParameterName::L,			1.0f,	{ 0.25f, 2.0f }, { "Pitch", 0.5f}); // reduced to 0.25 (originally 0.12) because of unstable range
